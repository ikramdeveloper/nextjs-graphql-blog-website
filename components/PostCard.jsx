  ...
  return (
    <article className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
      ...
      <div className="block lg:flex text-center items-center justify-center mb-8 w-full">
        <figure className="flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8">
          <Image
      ...
      <div className="text-center">
        <Link href={`/post/${post.slug}`}>
          <span className="transition transform hover:-translate-y-1 duration-500 inline-block bg-blue-600 text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer">
            Continue Reading
          </span>
        </Link>
      </div>
